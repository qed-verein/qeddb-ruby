describe("herbergen", () => {
  ...
  it("should be possible to add and delete a hostel", () => {
    ...
    cy.get('input[name="hostel[address_attributes][street_name]"]')
      .clear()
      .type("Zypressenstraße");
    cy.get('input[name="hostel[address_attributes][house_number]"]')
      .clear()
      .type("24");
    cy.get('input[name="hostel[address_attributes][postal_code]"]')
      .clear()
      .type("65537");
    cy.get('input[name="hostel[address_attributes][city]"]')
      .clear()
      .type("Sonthofen");
