...
json.extract! person, :id, :account_name, :first_name, :last_name,
              :email_address, :birthday, :gender, :joined, :quitted, :active, :archived, :paid_until
...
json.partial! partial: 'sepa_mandate', person: person if modules.include? :sepa_mandate
